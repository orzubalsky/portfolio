...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.credits'
        db.alter_column(u'portfolio_project', 'credits', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.credits'
        db.alter_column(u'portfolio_project', 'credits', self.gf('tinymce.models.HTMLField')(null=True))
