...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'portfolio_project', 'source_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.project_link'
        db.add_column(u'portfolio_project', 'project_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'portfolio_project', 'source_link')

        # Deleting field 'Project.project_link'
        db.delete_column(u'portfolio_project', 'project_link')
