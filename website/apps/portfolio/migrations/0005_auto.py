...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field vimeos on 'Project'
        m2m_table_name = db.shorten_name(u'portfolio_project_vimeos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'portfolio.project'], null=False)),
            ('vimeo', models.ForeignKey(orm[u'portfolio.vimeo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'vimeo_id'])

        # Adding M2M table for field vimeos on 'Post'
        m2m_table_name = db.shorten_name(u'portfolio_post_vimeos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm[u'portfolio.post'], null=False)),
            ('vimeo', models.ForeignKey(orm[u'portfolio.vimeo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['post_id', 'vimeo_id'])


    def backwards(self, orm):
        # Removing M2M table for field vimeos on 'Project'
        db.delete_table(db.shorten_name(u'portfolio_project_vimeos'))

        # Removing M2M table for field vimeos on 'Post'
        db.delete_table(db.shorten_name(u'portfolio_post_vimeos'))
